...
DEFAULT_PACKAGES:=base-files libc libgcc busybox mtd uci opkg 
# For router targets
DEFAULT_PACKAGES.router:=dnsmasq iptables ip6tables ppp ppp-mod-pppoe kmod-ipt-nathelper 6relayd odhcp6c
