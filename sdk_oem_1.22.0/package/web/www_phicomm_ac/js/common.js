 ...
 * 设置wifi账户密码
 */
function setWifiAp(type, ssid, pwd, channel, hidden_ssid, wifiBandwidth) {
    var dat = "fname=net&opt=wifi_ap" + type + "&function=set&ssid=" + ssid + "&passwd=" + pwd + "&hidden=" + hidden_ssid + "&channel=" + channel + "&bw=" + wifiBandwidth;
    $.ajax({
        type: "POST",
        url: actionUrl + dat,
        dataType: "json",
