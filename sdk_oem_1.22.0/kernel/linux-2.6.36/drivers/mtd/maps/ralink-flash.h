...
/*start: modified by zhangguoquan on 2014-10-29*/
#define MTD_BOOT_PART_OFFSET    0x00000000
#define MTD_BOOT_PART_SIZE      0x00030000
#define MTD_CONFIG_PART_OFFSET  0x00030000
#define MTD_CONFIG_PART_SIZE    0x00010000
#define MTD_FACTORY_PART_OFFSET 0x00040000
#define MTD_FACTORY_PART_SIZE   0x00010000

#if defined(CONFIG_RT2880_FLASH_8M)
#define  MTD_KERN_ROOTFS_PART_SIZE    0x007A0000
#define MTD_PARAM_PART_OFFSET  0x00050000
#define MTD_PARAM_PART_SIZE     0x00010000
#define MTD_KERN_ROOTFS_PART_OFFSET    0x00060000
#elif defined(CONFIG_RT2880_FLASH_16M)
#define  MTD_KERN_ROOTFS_PART_SIZE   0x00FA0000
#elif  defined(CONFIG_RT2880_FLASH_32M)
#define  MTD_KERN_ROOTFS_PART_SIZE    0x01FA0000
#elif  defined(CONFIG_RT2880_FLASH_4M)
#define  MTD_KERN_ROOTFS_PART_SIZE    0x03A0000
#define MTD_KERN_ROOTFS_PART_OFFSET    0x00050000
#endif

//#define MTD_KERN_PART_OFFSET    0x00060000
//#define MTD_KERN_PART_SIZE         0x00190000
//#define MTD_ROOTFS_PART_OFFSET  0x001F0000
//#define MTD_ROOTFS_PART_SIZE  (MTD_KERN_ROOTFS_PART_SIZE -  MTD_ROOTFS_PART_OFFSET)
...
#endif
#endif
/*end: modified by zhangguoquan on 2014-10-29*/
