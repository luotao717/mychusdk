 ...
 *                     \/            \/     \/    \/            \/
 * $Id: //WIFI_SOC/MP/SDK_4_2_0_0/RT288x_SDK/source/linux-2.6.21.x/drivers/char/i2s/wm8750.c#4 $
 *
...
int audiohw_set_master_vol(int vol_l, int vol_r)
{
	...
	wmcodec_write(LOUT1, LOUT1_BITS | LOUT1_LOUT1VOL(0x79));
	wmcodec_write(ROUT1, ROUT1_BITS | ROUT1_ROUT1VOL(0x79));

	wmcodec_write(LOUT2, LOUT2_BITS | LOUT2_LOUT2VOL(0x79));
	wmcodec_write(ROUT2, ROUT2_BITS | ROUT2_ROUT2VOL(0x79));
